...
public class MainGUI extends JPanel implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			BufferedReader fakeReader = new BufferedReader(new FileReader(pathToDirectory + "fakeFile.txt"));
			String ignoranceSpill;
			while((ignoranceSpill = fakeReader.readLine()) != null) {
				topTextArea.append(ignoranceSpill + newline + newline);
			}
...
class WriteFakeNews implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	NewsFolder.writeToFile(contents);
